...
public class DisplayMainMenu {
    ...
    public static void displayMenu() {
        try {
            ...
            do {
                check = true;
                System.out.print("List of managers and managers of Furama. resort " +
    ...
    public static void employeeDisplay() {
        try {
            ...
            do {
                check = true;
                System.out.print("Select the function of item employees" +
    ...
    public static void customerDisplay() {
        try {
            ...
            do {
                check = true;
                System.out.print("Select the function of the item customers" +
    ...
    public static void facilityDisplay() {
        try {
            ...
            do {
                check = true;
                System.out.print("Select the function of the item facility" +
    ...
    public static void bookingDisplay() {
        try {
            ...
            do {
                check = true;
                System.out.print("Select the function of the item booking" +
                        "\n1. Add new booking" +
    ...
    public static void promotionDisplay() {
        try {
            ...
            do {
                check = true;
                System.out.print("Select the function of the item promotion" +
