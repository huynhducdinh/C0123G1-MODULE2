package module_2_apj.service.hopdongthue;

import module_2_apj.molel.bookingorcontract.Contract;
import module_2_apj.repositroy.hopdongthue.HopDongThueRepo;
import module_2_apj.repositroy.hopdongthue.IIHopDongThueRepo;

import java.util.List;
import java.util.Scanner;

public class HopDongThueServiceIml implements IHopDongThue {
    static IIHopDongThueRepo hopDongThueRepo = new HopDongThueRepo();
